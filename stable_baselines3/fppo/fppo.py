...
class FPPO(OnPolicyAlgorithm):
    """
    Factorized PPO: uses a causal matrix that determines how advantage should be calculated across
        different action dimension
    ...
    def train(self) -> None:
        ...
        for epoch in range(self.n_epochs):
            ...
            for rollout_data in self.rollout_buffer.get(self.batch_size):
                ...
                policy_loss = -th.min(policy_loss_1, policy_loss_2).sum(axis=1).mean()
                ...
                assert self.value_loss_normalization == False
        ...
        # Added logs
        self.logger.record("train/stopping_epoch", epoch)
