...
class FactoredActorCriticPolicy(ActorCriticPolicy):
    """
    Policy class for actor-critic algorithms (has both policy and value prediction).

    Used by FPPO.
    Takes in reward_dim which affect the output shape of the reward network
...
class FactoredActorCriticCnnPolicy(FactoredActorCriticPolicy):
    """
    CNN policy class for actor-critic algorithms (has both policy and value prediction).
    Used by FPPO.
    Takes in reward_dim which affect the output shape of the reward network
...
class FactoredMultiInputActorCriticPolicy(FactoredActorCriticPolicy):
    """
    MultiInputActorClass policy class for actor-critic algorithms (has both policy and value prediction).
    Used by FPPO.
    Takes in reward_dim which affect the output shape of the reward network
