...
SelfMultiOneHotCategoricalDistribution = TypeVar("SelfMultiOneHotCategoricalDistribution", bound="MultiOneHotCategoricalDistribution")
...
class MultiOneHotCategoricalDistribution(Distribution):
    """
    MultiCategorical distribution for multi discrete actions.
    ...
    def proba_distribution(
        self: SelfMultiOneHotCategoricalDistribution, action_logits: th.Tensor
    ) -> SelfMultiOneHotCategoricalDistribution:
        self.distribution = [OneHotCategorical(logits=split) for split in th.split(action_logits, tuple(self.action_dims), dim=1)]
        return self
